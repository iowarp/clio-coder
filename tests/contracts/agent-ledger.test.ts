 ...
 */
const V18_BASE_RECEIPT_DIGEST = "d6e0f1e444a7ea8879cbd8e784d3b903f99b307c328b4ebf70f50e3e5ff42a3b";
...
describe("contracts/agent-ledger receipt", () => {
	it("keeps the v18 base receipt digest stable without a ledger contribution", () => {
		...
		strictEqual(RUN_RECEIPT_INTEGRITY_VERSION, 18, "the v18 receipt digest covers council provenance");
		strictEqual(integrity.digest, V18_BASE_RECEIPT_DIGEST);
	});
	...
	it("covers the contribution in integrity and digests it distinctly when present", () => {
		...
		ok(sealed.digest !== V18_BASE_RECEIPT_DIGEST, "a sealed contribution is inside the digest");
