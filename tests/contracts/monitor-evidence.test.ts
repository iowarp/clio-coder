...
describe("contracts/monitor collect evidence labeling", () => {
	it("labels sealed receipt text and fails closed for canceled, tampered, and missing receipts", async () => {
		...
		match(verified, /receipt_integrity=verified\/v7\/sha256/);
		...
		match(unverified, /receipt_integrity=verified\/v7\/sha256/);
		...
		match(recon, /receipt_integrity=verified\/v7\/sha256/);
		...
		match(unknown, /receipt_integrity=verified\/v7\/sha256/);
