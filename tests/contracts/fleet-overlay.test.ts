		...
		formatFleetOverlayBodyLines(
			snapshot({
				...
				totals: {
					...
					totalTokens: 2,
					costUsd: 0.125,
					cost: { knownUsd: 0.125, hasEstimated: true, hasUnknown: true, allKnownFree: false, calls: 1 },
					runtimeSeconds: 1,
				},
			}),
		).join("\n"),
		...
		const lines = formatFleetOverlayBodyLines(
			snapshot({
				...
				totals: {
					...
					totalTokens: 142,
					costUsd: 0.0012,
					cost: { knownUsd: 0.0012, hasEstimated: false, hasUnknown: false, allKnownFree: false, calls: 1 },
					runtimeSeconds: 12,
				},
			}),
		);
			...
			formatFleetOverlayBodyLines(
				snapshot({
					totals: {
						...
						totalTokens: 142,
						costUsd: 0.42,
						cost: { knownUsd: 0.42, hasEstimated: false, hasUnknown: false, allKnownFree: false, calls: 1 },
						runtimeSeconds: 12,
					},
				}),
			).join("\n"),
