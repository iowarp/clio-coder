...
export function evalInventoryFixture(): WireEvalInventory {
	return {
		scope: "installation",
		inspectedAt: "2026-08-31T16:20:02.000Z",
		generatedAt: "2026-08-31T16:20:00.000Z",
		available: true,
		stored: 3,
		// One report in the window is in a format this build no longer reads.
		unreadable: 1,
		reports: [
			{
				...
				servingGroup: 1,
				clioCoderVersion: "0.3.9",
				clioCoderCommit: "7cf5b06a5e2d429a2ed06b086cb335793fa5a9c7",
				platform: "linux-x64",
				node: "v24.9.0",
				...
				// The suite result passed and the behavioral judge disagreed, which is
				// a real state and not a contradiction.
				behaviorOutcomes: [
			...
			{
				// No serving observation, so the matrix it declared is standing in and
				// nothing beyond target, model, and thinking is known.
	...
	return {
		...
		skills: {
			...
			items: [{
				...
				updatable: true,
				audit: "pass",
				installedAt: "2026-07-02T09:15:00.000Z",
				updatedAt: null,
			}, {
				name: "release-notes",
				description: "Drafts a release note from the durable run journal for operator review.",
				scope: "project",
				source: "clio",
				trusted: true,
				...
				updatable: false,
				audit: "unknown",
				installedAt: "2026-08-11T18:40:00.000Z",
