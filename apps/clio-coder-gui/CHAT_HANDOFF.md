...
The GUI is ready to be called an alpha: `README.md` says so, and every item the previous handoff listed is done or waits only on the runtime requests below.
