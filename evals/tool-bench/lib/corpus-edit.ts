/**
 * The edit tool's scenario table and builder. See corpus.ts for the shared
...
export interface EditScenario extends ScenarioBase {
	tool: "edit";
	args: EditCall;
}
...
export function generateEditScenario(seed: number, split: Split, key: string): EditScenario {
