 ...
 * give. There is no operator on the other end of `clio run`, so every ask-rail
 ...
 * pins.
 */
export const HEADLESS_PERMISSION_DENIED_MARKER = "clio run cannot confirm permission requests";
