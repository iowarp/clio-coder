 ...
 *   - limitation: a successful `limitation` tool receipt, which the forensic
 *     layer records as the `completion-evidence` info row for a run that
 *     finished limited instead of evidenced.
 */
