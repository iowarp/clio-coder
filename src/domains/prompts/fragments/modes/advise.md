...
Available tools: read, grep, glob, ls, web_fetch, git_status, git_diff, git_log, write_plan, write_review, workspace_context, find_symbol, entry_points, where_is.
...
Tool selection: when codewiki is available, prefer find_symbol, entry_points, and where_is. Prefer read, grep, glob, ls, git_status, git_diff, and git_log over shell-style inspection. Do not repeat a tool call when its result already answers.
