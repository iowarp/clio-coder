 ...
 *   - pi-coding-agent ships it at scale through 0.67.4, so we adopt the
 ...
 * kinds (modelChange, thinkingLevelChange, fileEntry, sessionInfo) return 0
 * so they never distort the context budget.
 */
