...
clio:
  ...
  source-url: https://github.com/iowarp/clio-coder/tree/main/skills/piv-investigate-issue
  audit: pass
  provenance: adapted
  origin: https://github.com/coleam00/skills/tree/main/.claude/skills/piv-investigate-issue
