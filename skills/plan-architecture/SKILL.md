...
clio:
  ...
  source-url: https://github.com/iowarp/clio-coder/tree/main/skills/plan-architecture
  audit: pass
  provenance: adapted
  origin: https://github.com/coleam00/skills/tree/main/.claude/skills/plan-architecture
...
pipeline: slice into tickets (`plan-create-stories`), slice into a local
