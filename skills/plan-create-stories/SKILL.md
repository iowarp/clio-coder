...
clio:
  ...
  source-url: https://github.com/iowarp/clio-coder/tree/main/skills/plan-create-stories
  audit: pass
  provenance: adapted
  origin: https://github.com/coleam00/skills/tree/main/.claude/skills/plan-create-stories
