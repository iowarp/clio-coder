---
name: piv-commit
description: Use when the user asks to commit the current work — "commit this", "make a commit", "commit what we did" — and the changes are complete. Stages reviewed files, writes one atomic conventional-tagged commit, and reports what changed. Local commit only; never pushes. Not for opening a PR; use piv-create-pr.
version: 0.1.0
license: Apache-2.0
allowed-tools:
  - read
...
clio:
  ...
  source-url: https://github.com/iowarp/clio-coder/tree/main/skills/piv-commit
  audit: pass
  provenance: adapted
  origin: https://github.com/coleam00/skills/tree/main/.claude/skills/piv-commit
