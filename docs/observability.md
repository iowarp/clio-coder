...
> [!TIP]
> **Interactive Spec Available:** An interactive dashboard is located at [docs/html/observability_blueprint.html](html/observability_blueprint.html) (Version: 0.3.5).
...
| `autonomyEnforcement.grade` | `string` | Always in v0.3.5 | The autonomy grade level enforced for the run | experimental |
| `autonomyEnforcement.autonomy` | `string` | Always in v0.3.5 | The effective autonomy level name (e.g. auto-edit, suggest, read-only, full-auto) | experimental |
