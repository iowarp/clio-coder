...
> [!TIP]
> **Interactive Spec Available:** An interactive internal evaluation suite regression seeds explorer and internal validation checklist is located at [docs/html/evals_internal_blueprint.html](html/evals_internal_blueprint.html) (Version: 0.2.9).
