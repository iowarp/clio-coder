...
| [prompt-envelope-and-tools.md](prompt-envelope-and-tools.md) | `src/domains/prompts/compiler.ts`, `src/interactive/chat-loop.ts`, `src/tools/palette.ts`, `src/tools/registry.ts`, `src/engine/worker-tools.ts` | Prompt envelope, dynamic context, provider tool contracts, registry enforcement. |
