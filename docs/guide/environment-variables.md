...
| `CLIO_CODER_ALLOW_EXTERNAL_FULL_ACCESS` | off | `1` lets yolo pass through to external CLI runtimes with their own full access ([subprocess-runtime.ts](../../src/engine/claude/subprocess-runtime.ts), [subprocess-runtime.ts](../../src/engine/antigravity/subprocess-runtime.ts)). |
