...
| --- | --- | --- |
| P0 completion vs validation | Done notes remain claims; failed/missing checks show unverified in task list and overlay, including repeat history. Ungrounded sealed writer receipts name the next host check. | `c6d0ae36`, `aee603d4` |
...
| P2 handoff wording | Packaged handoff instructions distinguish interactive and headless `ask_user`; skill pin/version refreshed. | `78f2f3c8` |
...
Verification: Clio full tests TypeScript check, build, GUI TypeScript, skill pin check,
46 focused budget/skill tests, 29 focused task/memory tests, 4 dispatch batch/host
tests, 2 timeout tests, 11 evidence-tool tests, and both GUI evidence HTTP tests
