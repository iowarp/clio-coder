...
> [!TIP]
> **Interactive Spec Available:** A source-checkout dashboard is available at [docs/html/architecture_blueprint.html](https://github.com/iowarp/clio-coder/blob/main/docs/html/architecture_blueprint.html).
