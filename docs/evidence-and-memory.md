...
|---|---|---|
| v16 | Current canonical projection; every current receipt and reconstructible ledger field is authenticated | Accepted |
...
integrity remains version 16, evidence bundles remain version 1, gate decisions
