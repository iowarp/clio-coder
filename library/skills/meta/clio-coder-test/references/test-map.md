...
| Required GUI boundaries | Selected files in `apps/clio-coder-gui/tests/` | `npm run test:gui` | Root build |
| Full GUI investigation | All GUI tests and browser matrix | `pnpm --filter @iowarp/clio-coder-gui verify` | Yes |
